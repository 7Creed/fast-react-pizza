...
function Button({children, disabled, to, type}) {
    ...
    const base= "bg-yellow-400 inline-block text-sm text-stone-800 uppercase tracking-wide font-semibold rounded-full hover:bg-yellow-300 transition-colors duration-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:bg-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed"
    ...
    if (to) {
        return <Link className={styles[type]} to={to}>
                {children}
            </Link>
    }
